...
public class DefaultAuthorizationServerConsentTests {
    ...
    private final String redirectUri = "http://127.0.0.1/login/oauth2/code/web-client-oidc";

    private final String authorizationRequestUri = UriComponentsBuilder
        .fromPath("/oauth2/authorize")
        .queryParam("response_type", "code")
        .queryParam("client_id", "web-client")
        .queryParam("scope", "openid todo.read todo.write")
    ...
    public void whenUserConsentsToAllScopesThenReturnAuthorizationCode() throws IOException {
        ...
        assertThat(scopeIds).containsExactlyInAnyOrder("todo.read", "todo.write");
