package com.imooc.simpleserver;
...
public class DefaultAuthorizationServerApplicationTests {
    private static final String REDIRECT_URI = "http://127.0.0.1:8081/login/oauth2/code/web-client-oidc";

    private static final String AUTHORIZATION_REQUEST = UriComponentsBuilder
        .fromPath("/oauth2/authorize")
        .queryParam("response_type", "code")
        .queryParam("client_id", "web-client")
    ...
    public void whenLoginSuccessfulThenDisplayNotFoundError() throws IOException {
        ...
        WebResponse signInResponse = signIn(page, "user", "12345678").getWebResponse();
    ...
    public void whenLoggingInAndRequestingTokenThenRedirectsToClientApplication() throws IOException {
        ...
        signIn(this.webClient.getPage("/login"), "user", "12345678");
